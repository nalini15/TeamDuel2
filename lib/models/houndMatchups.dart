...
class HoundMatchupsData {
  ...
  HoundMatchupsData.fromJson(Map<String, dynamic> json) {
    raceId = json['race_id'];
...
class MatchupOne {
  ...
  MatchupOne.fromJson(Map<String, dynamic> json) {
    horseNo = json['hound_no'].toString();
    horseName = json['hound_name'].toString();
...
class HoundMatchesData {
  String locations;
  HoundMatchesData({this.locations});
}
