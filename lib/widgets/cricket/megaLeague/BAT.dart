    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                GestureDetector(
                                  onTap: () {
                                    print(index);
                                    print(players.bat[index]['id']);
                                    players.toggleBAT(
                                        players.bat[index]['id'], true);
                                  },
                                  child: Icon(
                                    Icons.minimize,
                                    size: 24,
          ...
          buildSizedBox(buildHeight(context), 0.02),
          Column(
              children: List.generate(players.dummybat.length, (index) {
            return Container(
              margin: EdgeInsets.only(bottom: 8),
              height: 98,
              width: double.infinity,
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  GestureDetector(
                    onTap: () {
                      // if (players.currentPlaySection ==
                      //     SelectPlayerSections.bat) {
                      //   if (players.bat.length <= 4) {
                      players.toggleBAT(players.dummybat[index]['id'], false);
                      //   }
                      // }
                    },
                    child: Icon(
